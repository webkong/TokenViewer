...
const copy = {
  en: {
    ...
    pageDescription:
      "TokenViewer is a free, native macOS menu-bar app that tracks your AI token usage and costs across 22 providers — Claude, Codex, Kiro, Cursor, Copilot and more. Local-first, no cloud required.",
    pageKeywords:
    ...
    hero: {
      ...
      description:
        "TokenViewer sits in your menu bar and quietly tracks token usage and costs across 22 AI coding tools. See where your tokens go — today, this week, or over time.",
      primary: "Download for macOS",
      secondary: "See features",
      proof: ["Free", "22 providers", "Local-first"],
    ...
    providers: {
      ...
      list: [
        ...
        "Hermes", "Antigravity", "CodeBuddy", "OhMyPi", "Pi",
        "KiloCLI", "EveryCode",
      ],
    },
    footer: {
  ...
  zh: {
    ...
    pageDescription:
      "TokenViewer 是一款免费的原生 macOS 菜单栏应用，追踪 22 个 AI 工具的 Token 用量与费用 — 包括 Claude、Codex、Kiro、Cursor、Copilot 等。本地优先，无需云端。",
    pageKeywords:
    ...
    hero: {
      ...
      description:
        "TokenViewer 静默驻守在菜单栏，实时统计 22 个 AI 编程工具的 Token 用量与费用。今天用了多少、这周花了多少，一目了然。",
      primary: "下载 macOS 版本",
      secondary: "查看功能",
      proof: ["永久免费", "支持 22 个工具", "本地优先"],
